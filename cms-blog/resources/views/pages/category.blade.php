                                ...
                                @foreach($category->posts as $p)
                                 <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        ...
                                        <small class="firstsmall"><a class="bg-orange" href="{{route('category.single', $category->id)}}" title="">{{$category->name}}</a></small>
                                        <small><a href="" title="">{{$p->created_at->toFormattedDateString()}}</a></small>
                                        <p> This post is about <strong>{{$p->title}}</strong> who have done something amazing in his life. He taught us something that live your life not just for yourself but for others as well.  </p>
                                        <small><a href="tech-author.html" title="">by {{$user->name}}</a></small>
